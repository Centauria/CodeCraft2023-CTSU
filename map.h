...
inline Argument load_args(Point x){
    ...
    if(x==Point{24.75,49.25}){
        ...
        args.ANTICOL_WHEEL_K = 2.0366672510564623;
        args.ANTICOL_FLEX_WHEEL = true;
        args.ANTICOL_WEIGHT_A = 5.255566623178697;
        args.ANTICOL_WEIGHT_B = 1.7914091554704017;
        args.DRIVING_P_ERROR_CORRECTION = 0.3236659098402036;
        args.DRIVING_SPEEDDOWN_A = 24.0;
        args.DRIVING_SPEEDDOWN_B = -0.5;
        args.DRIVING_TURN_BREAK = 0.7289244626902096;
        args.DRIVING_WEIGHT_A = 33.7574946698258;
        args.DRIVING_WEIGHT_B = 1.2383027145290981;
        args.DRIVING_THRESHOLD = 1.3381106193849903;
        args.IF_ALREADY_PRODUCING = 11.749881729272214;
        args.IF_NOTHING_INSIDE = 13.374298970088034;
        args.AVERAGING_456 = 3.7169225053803197;
        args.DONT_FILL_9_WORKBENCH = 3.6820229921562824;
        args.AVOIDING_COLLISION = 0.7288292902820332;
    } else if (x==Point{0.75,49.25}){
        args.ANTICOL_NEGLECT_R = 1.6420353109039447;
        args.ANTICOL_ALERT_R = 12.530216545146402;
        args.ANTICOL_WHEEL_K = 2.599682216528479;
        args.ANTICOL_FLEX_WHEEL = true;
        ...
        args.DRIVING_TURN_BREAK = 0.3764182933782392;
        ...
        args.IF_ALREADY_PRODUCING = 23.0;
        args.IF_NOTHING_INSIDE = 2.0;
        args.AVERAGING_456 = 1.6452523131786267;
        args.DONT_FILL_9_WORKBENCH = 3.059622608339817;
        ...
        args.IF_NOTHING_INSIDE = 2.173064308850075;
        args.AVERAGING_456 = 2.9403897795274343;
        args.DONT_FILL_9_WORKBENCH = 5.274180441750716;
        args.AVOIDING_COLLISION = 0.5779571315214527;
